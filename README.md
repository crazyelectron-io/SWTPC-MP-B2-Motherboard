...
SWTPC MP-B2 Motherboard schematics and documentation.
...
When later committing the MP-B2 repository, the submodule dependency is also registered and when cloning it again, run the following commands to get the submodule(s) back:
